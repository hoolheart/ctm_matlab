...
% intersection 1
int = ctm_add_int([1 2 3 4],[5 17 18 12],[2 0.6;1 0.6;1 0.2;2 0.6;1 0.6;1 0.2]);
ctm_add_phase(int,...
             [2 0.9 1 1 0 1 0 2;...
...
% intersection 2
int = ctm_add_int([5 6 7 8],[19 2 20 16],[2 0.6;1 0.6;1 0.2;2 0.6;1 0.6;1 0.2]);
ctm_add_phase(int,...
             [2 0.9 1 1 0 1 0 2;...
              2 0.8/0.9 0 1 2 1 0 3;...
              2 0.9 1 2 0 4 0 5;...
...
% intersection 3
int = ctm_add_int([9 10 11 12],[13 21 3 22],[2 0.6;1 0.6;1 0.2;2 0.6;1 0.6;1 0.2]);
ctm_add_phase(int,...
             [2 0.9 1 1 0 1 0 2;...
              2 0.8/0.9 0 1 2 1 0 3;...
              2 0.9 1 2 0 4 0 5;...
...
% intersection 4
int = ctm_add_int([13 14 15 16],[23 10 7 24],[2 0.6;1 0.6;1 0.2;2 0.6;1 0.6;1 0.2]);
ctm_add_phase(int,...
             [2 0.9 1 1 0 1 0 2;...
              2 0.8/0.9 0 1 2 1 0 3;...
              2 0.9 1 2 0 4 0 5;...
