...
ini_4int_queues([46*2;56*2;22;19;12*2;26*2;39;39;44;32;21;24;59;57;6;5]);
...
S = diag([0.6*2;0.6*2;0.4;0.4;0.6*2;0.6*2;0.4;0.4;0.6;0.6;0.4;0.4;0.6;0.6;0.4;0.4]);
...
x = zeros(16,n+1);
ug = zeros(4,n);
x(:,1) = [46*2;56*2;22;19;12*2;26*2;39;39;44;32;21;24;59;57;6;5];
w = zeros(16,n);
delay = zeros(1,n);
output = zeros(24,n);
for i=1:n
